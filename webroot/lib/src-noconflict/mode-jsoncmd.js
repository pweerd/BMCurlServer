ace.define('ace/mode/jsoncmd', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/mode/text', 'ace/tokenizer', 'ace/mode/jsoncmd_highlight_rules', 'ace/mode/matching_brace_outdent', 'ace/mode/behaviour/cstyle', 'ace/mode/folding/cstyle', 'ace/worker/worker_client'], function (require, exports, module) {


   var oop = require("../lib/oop");
   var TextMode = require("./text").Mode;
   var HighlightRules = require("./jsoncmd_highlight_rules").JsonCmdHighlightRules;
   ...
   (function () {
      ...
      this.createWorker = function (session) {
         var worker = new WorkerClient(["ace"], "ace/mode/jsoncmd_worker", "JsonCmdWorker");
...
ace.define('ace/mode/jsoncmd_highlight_rules', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/mode/text_highlight_rules'], function (require, exports, module) {


   var oop = require("../lib/oop");
   var TextHighlightRules = require("./text_highlight_rules").TextHighlightRules;

   var JsonCmdHighlightRules = function () {
      ...
      this.$rules = {
         ...
         "method_sep": mergeTokens(
            addEOL(["whitespace", "url.slash"], /(\s+)(\/)/, "start", "urlRest"),
            addEOL(["whitespace"], /(\s+)/, "start", "urlRest")
         ),
         "urlRest": mergeTokens(
   ...
   oop.inherits(JsonCmdHighlightRules, TextHighlightRules);

   exports.JsonCmdHighlightRules = JsonCmdHighlightRules;
