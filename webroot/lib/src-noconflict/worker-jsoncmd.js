...
define('ace/mode/jsoncmd_worker', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/worker/mirror', 'ace/mode/jsoncmd/jsoncmd_parse'], function (require, exports, module) {


   var oop = require("../lib/oop");
   var Mirror = require("../worker/mirror").Mirror;
   var parse = require("./jsoncmd/jsoncmd_parse");

   var JsonCmdWorker = exports.JsonCmdWorker = function (sender) {
      Mirror.call(this, sender);
      this.setTimeout(200);
   };

   oop.inherits(JsonCmdWorker, Mirror);
...
define('ace/mode/jsoncmd/jsoncmd_parse', ['require', 'exports', 'module' ], function (require, exports, module) {
